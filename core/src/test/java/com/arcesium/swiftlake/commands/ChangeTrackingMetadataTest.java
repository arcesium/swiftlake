...
class ChangeTrackingMetadataTest {
  ...
  void testBasicFunctionality() {
    ...
    ChangeTrackingMetadata<String> metadata =
        new ChangeTrackingMetadata<>(maxDeltaValue, nullReplacement);
  ...
  void testWithNullValues() {
    ChangeTrackingMetadata<String> metadata = new ChangeTrackingMetadata<>(null, null);
