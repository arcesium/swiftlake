...
/** Represents metrics for a file system cache. */
public class FileSystemCacheMetrics implements Metrics {
  ...
  /**
   * Constructs a FileSystemCacheMetrics object with the specified metrics.
   *
  ...
  /**
   * Returns a string representation of the FileSystemCacheMetrics object.
   *
   * @return A string representation of the object.
   */
  @Override
  public String toString() {
    return "FileSystemCacheMetrics{"
        + "hitCount="
        + hitCount
        + ", missCount="
        + missCount
